...
class Multipart {
        ...
        try {
            const response = await handler.handler(part, async (line) => {
                ...
                try {
                    ...
                    this.logger.fatal('Unhandled multipart stream error. Make sure to handle "error" events for all manually processed streams');
                }
            });
            /**
    ...
    processConfig(config) {
        ...
        this.upperLimit = typeof (this.config.limit) === 'string'
            ? bytes_1.default(this.config.limit)
            : this.config.limit;
    }
    /**
