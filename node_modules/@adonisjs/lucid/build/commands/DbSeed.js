...
let DbSeed = class DbSeed extends ace_1.BaseCommand {
...
__decorate([
    ace_1.flags.string({ description: 'Define a custom database connection for the seeders', alias: 'c' }),
    __metadata("design:type", String)
], DbSeed.prototype, "connection", void 0);
__decorate([
    ace_1.flags.boolean({ description: 'Run seeders in interactive mode', alias: 'i' }),
    __metadata("design:type", Boolean)
], DbSeed.prototype, "interactive", void 0);
__decorate([
    ace_1.flags.array({ description: 'Define a custom set of seeders files names to run', alias: 'f' }),
