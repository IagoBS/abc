...
class Cors {
     ...
     * match.
    */
    computedAllowedHeaders(headers) {
    ...
    async handle({ request, response }) {
         ...
         */
        let requestHeaders = request.header('Access-Control-Request-Headers');
         ...
         */
        const allowedHeaders = this.computedAllowedHeaders(requestHeaders);
        /**
