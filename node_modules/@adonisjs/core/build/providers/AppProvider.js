...
class AppProvider {
    ...
    registerHttpExceptionHandler() {
        this.container.bind('Adonis/Core/HttpExceptionHandler', () => HttpExceptionHandler_1.HttpExceptionHandler);
    }
    /**
    ...
    registerHealthCheck() {
        this.container.singleton('Adonis/Core/HealthCheck', () => {
            return new HealthCheck_1.HealthCheck(this.container.use('Adonis/Core/Application'));
        });
    }
    /**
    ...
    registerHealthCheckers() {
        this.container.with(['Adonis/Core/HealthCheck'], (healthCheck) => {
            Env_1.default(healthCheck);
            AppKey_1.default(healthCheck);
        });
    }
    /**
