...
class ArrayCompiler {
    ...
    compile(buff) {
         ...
         */
        buff.newLine();
        this.compiler.compileNode({ name: indexVariable, type: 'identifier' }, this.node.each, buff, this.references.parentPointer.concat(this.field), literal.variableName, outVariable);
        /**
