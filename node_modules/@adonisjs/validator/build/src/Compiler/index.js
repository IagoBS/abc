...
class Compiler {
    ...
    getMutationFnDeclararationExpression(variableName) {
        return endent_1.default `function ${this.getVariableMutationName(variableName)} (newValue) {
    ...
    getOptionsDeclarationExpression(variableName, field, tip, pointer, arrayExpressionPointer) {
        const arrayExpressionPointerItem = arrayExpressionPointer
            ...
            : '';
        return endent_1.default `const ${this.getVariableOptionsName(variableName)} = {
      root,
      refs,
      field: ${field},
      tip: ${tip},
    ...
    compileAsString() {
         ...
         */
        buffer.writeExpression(endent_1.default `
     ...
     */
    compile() {
        return new Function('root', 'validations', 'errorReporter', 'helpers', 'refs', this.compileAsString())();
    }
}
