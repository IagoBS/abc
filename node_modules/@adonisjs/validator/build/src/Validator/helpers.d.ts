 ...
 */
export declare function wrapCompile<T extends any>(name: string, restrictForTypes?: NodeSubType[], customCallback?: (options: any[], type: NodeType, subtype: NodeSubType) => Partial<ParsedRule<T>>): (type: NodeType, subtype: NodeSubType, options: T) => ParsedRule<T>;
