 ...
 */
exports.maxLength = {
    compile: helpers_1.wrapCompile(RULE_NAME, ['string', 'array'], ([limit], _, subtype) => {
    ...
    validate(value, compiledOptions, { errorReporter, pointer, arrayExpressionPointer }) {
        ...
        if (value.length > compiledOptions.maxLength) {
            errorReporter.report(pointer, RULE_NAME, DEFAULT_MESSAGE, arrayExpressionPointer, { maxLength: compiledOptions.maxLength });
        }
    },
};
