 ...
 */
exports.enumSet = {
    compile: helpers_1.wrapCompile(RULE_NAME, [], ([choices]) => {
        /**
         * Choices are defined as a ref
         */
        if (helpers_1.isRef(choices)) {
            return {
    ...
    validate(value, compiledOptions, { errorReporter, pointer, refs, arrayExpressionPointer }) {
        ...
        if (compiledOptions.ref) {
            ...
            helpers_1.enforceArray(runtimeChoices, `"${RULE_NAME}": expects "refs.${compiledOptions.ref}" to be an array`);
