...
exports.confirmed = {
    ...
    validate(value, _, { errorReporter, field, pointer, arrayExpressionPointer, root, tip }) {
        ...
        if (helpers_1.getFieldValue(`${field}_confirmation`, root, tip) != value) {
            errorReporter.report(`${pointer}_confirmation`, RULE_NAME, DEFAULT_MESSAGE, arrayExpressionPointer);
        }
    },
};
