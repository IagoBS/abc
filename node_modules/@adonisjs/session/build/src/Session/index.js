...
const MessageBag_1 = require("../MessageBag");
/**
...
class Session {
    constructor(ctx, config, driver) {
         ...
         */
        this.flashMessages = new MessageBag_1.MessageBag({});
        /**
    ...
    flashExcept(keys) {
        this.ensureIsReady();
        this.ensureIsMutable();
        this.flashMessagesStore.input = utils_1.lodash.omit(this.ctx.request.original(), keys);
    }
    /**
    ...
    flashOnly(keys) {
        this.ensureIsReady();
        this.ensureIsMutable();
        this.flashMessagesStore.input = utils_1.lodash.pick(this.ctx.request.original(), keys);
    }
    /**
