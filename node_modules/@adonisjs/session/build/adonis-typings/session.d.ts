...
declare module '@ioc:Adonis/Addons/Session' {
     ...
     */
    type ExtendCallback = (container: IocContract, config: SessionConfig, ctx: HttpContextContract) => SessionDriverContract;
    /**
     * The values allowed by the `session.put` method
     */
    type AllowedSessionValues = string | boolean | number | object | Date | Array<any>;
    /**
